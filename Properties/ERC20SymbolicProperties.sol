...
contract ERC20SymbolicProperties is Test {
    ...
    function prove_TransferFromAllowanceReachesZero(
        address owner,
        address spender,
        address recipient,
        uint256 amount,
    ...
    function prove_TransferFromZeroAmountToZeroAddressReverts(
        address tokenSender,
        address spender
    ) public {
    ...
    function prove_TransferZeroAmountToZeroAddressReverts(address sender) public {
...
// *********************************************** Revertable properties ********************************************************
    ...
    // Proves that transferring to the zero address reverts.
    function proveFail_TransferFromToZeroAddress(address owner, address spender, uint256 amount) public {
        require(owner != address(0) && spender != address(0) && amount > 0, "Invalid arguments");
        token.mint(owner, amount);
        token.approve(spender, amount);
        vm.prank(spender);
