...
import {ERC1155} from "@openzeppelin/token/ERC1155/ERC1155.sol"; // A contract to be formally verified
...
contract ERC1155RecTest {
    ...
    function onERC1155Received(address operator, address from, uint256 id, uint256 value, bytes calldata data) public /*external override*/ returns(bytes4) {
        // Just to enable safe functions
        return this.onERC1155Received.selector;
    }

    function onERC1155BatchReceived(address operator, address from, uint256[] calldata ids, uint256[] calldata values, bytes calldata data) public /*external override*/ returns (bytes4) {
        // Just to enable safe functions
